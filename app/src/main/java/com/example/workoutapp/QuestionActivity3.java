            ...
            public void onClick(View v) {
                switch (v.getId()){
                    ...
                    case R.id.btnBegginer:
                        Intent intent1 = new Intent(QuestionActivity3.this, QuestionActivity4.class);
                        startActivity(intent1);
                        overridePendingTransition(R.anim.slide_right_enter,R.anim.slide_right_exit);
                        break;
                    //두번째 버튼 행동
                    case R.id.btnLow:
                        Intent intent2 = new Intent(QuestionActivity3.this, QuestionActivity4.class);
                        startActivity(intent2);
                        overridePendingTransition(R.anim.slide_right_enter,R.anim.slide_right_exit);
                        break;
                    case R.id.btnMiddle:
                        Intent intent3 = new Intent(QuestionActivity3.this, QuestionActivity4.class);
                        startActivity(intent3);
                        overridePendingTransition(R.anim.slide_right_enter,R.anim.slide_right_exit);
                        break;
                    case R.id.btnHigh:
                        Intent intent4 = new Intent(QuestionActivity3.this, QuestionActivity4.class);
                        startActivity(intent4);
                        overridePendingTransition(R.anim.slide_right_enter,R.anim.slide_right_exit);
                        break;
                    case R.id.btnMaster:
                        Intent intent5 = new Intent(QuestionActivity3.this, QuestionActivity4.class);
